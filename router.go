...
func (r *Router) Add(method, path string, h Handler, name string, meta H, e *Han) (route *Route) {
...
func (r *Router) insert(path string, t kind, route *Route, e *Han) {
	// Adjust max param
	l := len(route.Params)
	if *e.maxParam < l {
		*e.maxParam = l
