...
type BoltOptions struct {
	...
	SessionOptions *han.SessionOptions `json:"session"`
}
...
func (s *Storex) Get(ctx han.Context, name string) (*sessions.Session, error) {
...
func (c *boltStore) Options(options han.SessionOptions) {
