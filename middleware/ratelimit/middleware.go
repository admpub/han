...
import (
	...
	"github.com/admpub/han/middleware/ratelimit/config"
	"github.com/admpub/han/middleware/ratelimit/errors"
)

func LimitMiddleware(limiter *config.Limiter) han.MiddlewareFunc {
...
func LimitHandler(limiter *config.Limiter) han.MiddlewareFunc {
