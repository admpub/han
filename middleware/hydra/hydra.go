...
func GetContext(c han.Context) *firewall.Context {
...
func ScopesRequired(opt interface{}, tokenAccessRequest *firewall.TokenAccessRequest, scopes ...string) han.MiddlewareFunc {
	var hc *hydraSDK.Client
	var err error
	var skipper han.Skipper
