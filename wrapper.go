...
// WrapHandler wrap `interface{}` into `han.Handler`.
...
// WrapMiddleware wrap `interface{}` into `han.Middleware`.
...
// WrapMiddlewareFromHandler wrap `han.HandlerFunc` into `han.Middleware`.
...
// WrapMiddlewareFromStdHandler wrap `http.HandlerFunc` into `han.Middleware`.
...
// WrapMiddlewareFromStdHandleFunc wrap `func(http.ResponseWriter, *http.Request)` into `han.Middleware`.
...
// WrapMiddlewareFromStdHandleFuncd wrap `func(http.ResponseWriter, *http.Request)` into `han.Middleware`.
