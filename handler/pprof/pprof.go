...
func Cmdline(e han.Context) {
	w := e.Response()
	w.Header().Set("Content-Type", "text/plain; charset=utf-8")
	fmt.Fprintf(w, strings.Join(os.Args, "\x00"))
}

func sleep(e han.Context, d time.Duration) {
	w := e.Response()
...
func (name handler) ServeHTTP(e han.Context) {
	w := e.Response()
	r := e.Request()
	w.Header().Set("Content-Type", "text/plain; charset=utf-8")
