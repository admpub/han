...
func NewContext(req engine.Request, res engine.Response, e *Han) Context {
	c := &xContext{
...
func (c *xContext) Bind(i interface{}, filter ...FormDataFilter) error {
	return c.han.binder.Bind(i, c, filter...)
}

func (c *xContext) MustBind(i interface{}, filter ...FormDataFilter) error {
	return c.han.binder.MustBind(i, c, filter...)
}

// Render renders a template with data and sends a text/html response with status
// code. Templates can be registered using `Han.SetRenderer()`.
...
// Han returns the `Han` instance.
func (c *xContext) Han() *Han {
	return c.han
}
...
func (c *xContext) Fetch(name string, data interface{}) (b []byte, err error) {
	if c.renderer == nil {
		if c.han.renderer == nil {
			return nil, ErrRendererNotRegistered
		}
		c.renderer = c.han.renderer
	}
...
func (c *xContext) MapData(i interface{}, data map[string][]string, names ...string) error {
	...
	return NamedStructMap(c.han, i, data, name)
}
